    ...
    struct Frac {
        ...
        Frac& operator+=(const Frac& r) {n=n*r.d+r.n*d,d*=r.d;reduce();return *this;}
        Frac& operator-=(const Frac& r) {n=n*r.d-r.n*d,d*=r.d;reduce();return *this;}
        Frac& operator*=(const Frac& r) {n*=r.n,d*=r.d;reduce();return *this;}
        Frac& operator/=(const Frac& r) {n*=r.d,d*=r.n;reduce();return *this;}
