...
public class JoshContext041206 {
    // 快速 I/O，应对 Bonus 测试集的 10^5 数据量
    ...
    public static void main(String[] args) {
        ...
        while (T-- > 0) {
            ...
            long N = sc.nextLong();
            long M = sc.nextLong();
            long P = sc.nextLong(); // Y 轴步长
            long Q = sc.nextLong(); // X 轴步长
    ...
    static long crt(long r1, long n1, long r2, long n2) {
        // t = r1 + k * n1 => k * n1 ≡ r2 - r1 (mod n2)
        long diff = (r2 - r1) % n2;
        if (diff < 0) diff += n2;

        long g = gcd(n1, n2);
        if (diff % g != 0) return -1; // 矛盾无解
