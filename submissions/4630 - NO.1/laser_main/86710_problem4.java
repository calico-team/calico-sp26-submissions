    ...
    public static void main(String[] args) throws Exception {
        ...
        while (T-- > 0) {
            ...
            for (int i = 0; i < K; i++) {
                ...
                long yi = Long.parseLong(st.nextToken());
                asteroids[i] = new Asteroid(xi, yi, i);
                if (i == 0) {
                    x0 = xi;
                    y0 = yi;
                }
