...
void solve() {
    ...
    vector<vector<int>> g(2 * z + 1, vector<int> (2 * z + 1));

    vector<vector<bool>> mrk1(2 * z + 1, vector<bool> (2 * z + 1));
    vector<vector<bool>> mrk2(2 * z + 1, vector<bool> (2 * z + 1));
    ...
    set<int> crt;
    for (int i = 2; i <= 2400; i += 2) crt.insert(i);
    for (int i = 7; i <= 2400; i += 7) crt.insert(i);
