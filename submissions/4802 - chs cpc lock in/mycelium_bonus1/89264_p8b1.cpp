...
void solve() {
    ...
    xg += 2000, yg += 2000, xm += 2000, ym += 2000;

    vector<vector<int>> g(4001, vector<int> (4001));

    vector<vector<bool>> mrk1(4001, vector<bool> (4001));
    vector<vector<bool>> mrk2(4001, vector<bool> (4001));
    ...
    set<int> crt;
    for (int i = 2; i <= 2250; i += 2) crt.insert(i);
    for (int i = 7; i <= 2250; i += 7) crt.insert(i);
