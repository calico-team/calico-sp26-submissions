...
def solve(X_G, Y_G, X_M, Y_M):
    ...
    while True:
        ...
        next_m = set()
        for tile in new_m:
            grid[tile] = MYC; g_cands.discard(tile); myc_count += 1
            x,y = tile
            for dx,dy in DIRS:
                n=(x+dx,y+dy)
