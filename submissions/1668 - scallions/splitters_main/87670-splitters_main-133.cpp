...
inline __int128_t gcd(__int128_t a, __int128_t b) {
	for (; b; swap(a, b)) a %= b;
	return a;
}
...
struct Frac {
	...
	Frac(__int128_t _a, __int128_t _b): a(_a), b(_b) {}
...
inline Frac operator +(const Frac& a, const Frac &b) {
	__int128_t A = (__int128_t)a.a * b.b + (__int128_t)a.b * b.a;
	__int128_t B = (__int128_t)a.b * b.b;
	auto G = gcd(A, B);
	A /= G;
	B /= G;
