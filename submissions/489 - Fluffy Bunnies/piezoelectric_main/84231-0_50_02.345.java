...
public class Solution {
	 ...
	 * 
	 * L: Length of car W: Width of car E: Amount of electricity to generate R:
	 * Electricity generated per unit distance
	 */
	static int solve(int L, int W, int E, int R) {
		int perimeter = 2 * L + 2 * W;
		int elecPerLap = perimeter * R;
		
		int laps = E / elecPerLap;
		
		return laps; // returns output
	}
