def solve(P, A, B):
    ...
    # 5 rows is just enough to safely output UP/DOWN
    rows = 5
    # Tightly pack the columns to exactly fit the bus to avoid trailing empty columns
    cols = 2 * K + 2 
    ...
    for i, d in enumerate(D):
        ...
        # Place the splitter (Using UPPERCASE 'S' to match sample test cases)
        grid[2][c] = 'S' 
