...
void solve() {
    ...
    xg += 600, yg += 600, xm += 600, ym += 600;

    vector<vector<int>> g(1201, vector<int> (1201));

    vector<vector<bool>> mrk1(1201, vector<bool> (1201));
    vector<vector<bool>> mrk2(1201, vector<bool> (1201));
    ...
    set<int> crt;
    for (int i = 2; i <= 1000; i += 2) crt.insert(i);
    for (int i = 7; i <= 1000; i += 7) crt.insert(i);
