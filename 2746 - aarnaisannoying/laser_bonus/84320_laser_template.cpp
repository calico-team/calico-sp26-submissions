...
//note to self: always try the bonus problems first, if u can solve them u can just reuse the code for the ez one
// if u fail , then do the ez one
...
bool crt(ll a1, ll m1, ll a2, ll m2, ll &v, ll &mod) { // yay number theroy(ts part was a pain to code)
	ll x, y;
	ll g = egcd(m1, m2, x, y);
	ll d = a2 - a1;
