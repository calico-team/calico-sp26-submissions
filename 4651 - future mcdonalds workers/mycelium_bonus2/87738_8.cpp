...
void solve() {
  ...
  //offset the neg coords bc bonus 1 is -3*10^3 to +3*10^3
  xg += 3000; yg += 3000; xm += 3000; ym += 3000;

  const int MAX = 12000; //maximum coordinate (3*10^3*4) as 3*10^3 is the limit for bonus set 1
